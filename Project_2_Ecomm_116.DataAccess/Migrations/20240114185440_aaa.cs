        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SuggestedProducts_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SuggestedProducts_CoverTypes_CoverTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SuggestedProducts_CategoryId",
                table: "SuggestedProducts",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_SuggestedProducts_CoverTypeId",
                table: "SuggestedProducts",
                column: "CoverTypeId");
        }
